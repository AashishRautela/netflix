  ...
  return (
    <div className='about-us mt-[70px] px-4 md:px-24'>
      ...
      <div className='mb-8 text-gray-200'>
        Github: <a href='https://github.com/AashishRautela' className='hover:text-blue-700 ml-3 text-blue-600 text-sm' target='_blank' rel='noreferrer'>NetflixGPT</a>
        <br />
        <br></br>
        Linkedin: <a href='https://www.linkedin.com/in/ashish-rautela-731227212/' className='hover:text-blue-700 ml-3 text-blue-600 text-sm' target='_blank' rel='noreferrer'>Ashish Rautela</a>
      </div>
